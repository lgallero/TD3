...
; === PIC MASTER: habilito solamente IRQ1 teclado [1111 1101 b] ===
  mov al, 0FDh ;
  out 21h, al
...
; -----------------------------------------
; Se imprime el mismo mensaje pero se deja generico para personalizar cada uno
